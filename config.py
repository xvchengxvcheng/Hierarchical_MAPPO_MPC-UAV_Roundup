...
def get_config():
    ...
    parser.add_argument("--method", type=str, default="PID", help="specify the name of method MPC or PID")
    parser.add_argument(
        "--use_obs_instead_of_state",
        action="store_true",
        default=False,
    ...
    parser.add_argument(
        ...
        help="Custom MLP hidden sizes for actor/critic, e.g. 512 256 128. Overrides hidden_size/layer_N.",
    )
    parser.add_argument(
        "--layer_N",
        type=int,
    ...
    # optimizer parameters
    parser.add_argument("--lr", type=float, default=2e-5, help="learning rate (default: 5e-4)")
    parser.add_argument(
        "--critic_lr",
        type=float,
        default=5e-5,
    ...
    # ppo parameters
    parser.add_argument("--ppo_epoch", type=int, default=6, help="number of ppo epochs (default: 15)")
    parser.add_argument(
        "--use_clipped_value_loss",
        action="store_false",
        default=True,
    ...
    parser.add_argument(
        "--model_dir",
        type=str,
        # default="results/MyEnv/MyEnv/mappo/check/run63/models",
        default=None,
